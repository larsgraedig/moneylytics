    ...
    <div className="shell">
      ...
      <div className="main-col">
        ...
        <main className="stage">
          ...
          {tab === 'kategorien' && <CategoriesPage key={`${username}-${activeOrganization?.id}`} categories={categories} from={from} to={to} iban={iban} onCategoryDeleted={() => { fetchCategories().then(cats => setCategories(cats.categories)).catch(() => {}) }} />}
